...
st.set_page_config(page_title="Will's EMA Scanner", layout="wide", initial_sidebar_state="expanded")
st.title("📈 Will's EMA Scanner")
st.caption("20/50 Bullish Crossover + Price Above 200 EMA | Real TradingView Charts Embedded")
